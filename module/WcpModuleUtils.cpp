...
std::string WcpModuleUtils::encodeBase64Image(cv::Mat cvimg)
{
    std::string ret;
    int i = 0;
    int j = 0;
...
cv::Mat WcpModuleUtils::decodeBase64Image(std::string encoded_image)
{
...
bool WcpModuleUtils::keyExist(const nlohmann::json& js, std::string key)
{
